return {
  ...
  description = 'Generate and apply a Conventional Commit-style message for staged Git changes.',
  opts = {
    is_default = true,
    is_slash_cmd = true,
    auto_submit = true,
...
4. Execute the commit using the proposed message using @{cmd_runner}.
      ]],
    },
  },
}
