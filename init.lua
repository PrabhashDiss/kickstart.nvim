...
vim.api.nvim_create_autocmd('FileType', {
  pattern = 'java',
  desc = 'Start or attach jdtls for Java files',
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<C-f>', builtin.git_files, { desc = '[S]earch [G]it [F]iles' })
      ...
      vim.keymap.set('n', '<leader>sF', function()
        local folder = vim.fn.input("Search in folder: ", vim.fn.getcwd() .. "/", "dir")
        if folder ~= "" then
      ...
      vim.keymap.set('n', '<leader>sG', function()
        local folder = vim.fn.input("Grep in folder: ", vim.fn.getcwd() .. "/", "dir")
        if folder ~= "" then
      ...
      vim.keymap.set('n', '<leader>sT', function()
        local folder = vim.fn.input("Git files in folder: ", vim.fn.getcwd() .. "/", "dir")
        if folder ~= "" then
  ...
  -- unpack(require('kickstart.plugins.treesitter')),
  ...
  require 'kickstart.plugins.treesitter-context', -- adds treesitter context
